  ...
  return (
    <div>
      <div className="container flex justify-center mx-auto pt-16">
        <div>
          <p className="text-slate-500 text-lg text-center font-normal pb-3">
            BUILDING TEAM
          </p>
          <h1 className="xl:text-4xl text-3xl text-center text-slate-800 font-extrabold pb-6 sm:w-4/6 w-5/6 mx-auto">
            Meet The People Behind the Scenes of the Organization
          </h1>
        </div>
      </div>
