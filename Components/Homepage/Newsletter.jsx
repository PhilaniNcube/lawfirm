      ...
      <div className="w-full bg-gray-100 py-16">
        <div className="xl:flex lg:flex md:flex flex-wrap items-center container mx-auto px-6">
          ...
          <div className="xl:w-5/12 lg:w-5/12 md:w-5/12 xl:pl-10 lg:pl-10 w-full xl:mx-0 lg:mx-0 mx-auto">
            <h1 className="xl:text-5xl text-3xl mb-6 text-gray-800">
              Subscribe.
            </h1>
            <p className="text-xl mb-8 text-gray-600 leading-7">
              Join and get to know about exciting offers, our latest events and
            ...
            <div className="w-full flex bg-white px-5 justify-between rounded shadow xl:w-10/12 items-center">
              <input
                ...
                id="email"
                aria-label="email"
                className="w-24 lg:w-auto bg-transparent focus:outline-none text-gray-800 py-6"
              />
